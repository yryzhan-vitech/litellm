...
def is_advisor_tool_chat_completion(tool: Any) -> bool:  # noqa: ANN401  # ported verbatim from fork main / prod image a2e1b93d30; upstream signature
    """
...
def is_advisor_tool(tool: Any) -> bool:  # noqa: ANN401  # ported verbatim from fork main / prod image a2e1b93d30; upstream signature
    """
