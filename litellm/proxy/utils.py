...
from litellm._logging import _redact_and_sanitize, _redact_string, verbose_proxy_logger
...
def print_verbose(print_statement):
    ...
    if litellm.set_verbose:
        print(f"LiteLLM Proxy: {_redact_and_sanitize(print_statement)}")  # noqa: T201
